...
<%
	...
	try {
		...
		if( rs.next() ) {
			...
			emot = rs.getString( "emot" ); System.out.println( emot );
		}
		
		// 이모티콘 정렬
		for( int i=1 ; i<=45 ; i++ ) {
			if( i%15 == 1 ) sbHtml.append( "<tr>" );
			sbHtml.append( "<td>" );
				if( i < 10 ) {System.out.println( emot );
					sbHtml.append( "<img src='../../images/emoticon/emot0" + i + ".png' width='25' /><br />" );
					if( i == Integer.parseInt( emot ) ) sbHtml.append( "<input type='radio' name='emot' value='emot0" + i + "' class='input_radio' checked='checked'/>" );
					else sbHtml.append( "<input type='radio' name='emot' value='emot0" + i + "' class='input_radio' />" );
				}
				else {
					sbHtml.append( "<img src='../../images/emoticon/emot" + i + ".png' width='25' /><br />" );
					if( i == Integer.parseInt( emot ) ) sbHtml.append( "<input type='radio' name='emot' value='emot" + i + "' class='input_radio' checked='checked'/>" );
					else sbHtml.append( "<input type='radio' name='emot' value='emot" + i + "' class='input_radio' />" );
				}
			sbHtml.append( "</td>" );
			if( i%15 == 0 ) sbHtml.append( "</tr>" );
		}
