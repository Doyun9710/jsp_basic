...
<%
	...
	if( !cookies.exists( "cid" ) || !cookies.exists( "cwdate" ) ) {
		// 로그인 안함
		out.println( "<script type='text/javascript'>" );
		out.println( "alert('로그인 필요')" );
		out.println( "location.href='login.jsp';" );
		out.println( "</script>" );
	} else if( cookies.getValue( "cid" ).equals("") || cookies.getValue( "cwdate" ).equals("") ) {
		out.println( "<script type='text/javascript'>" );
		out.println( "alert('로그인 필요')" );
		out.println( "location.href='login.jsp';" );
		out.println( "</script>" );
...
<div class="topnav">
	...
	<div class="loginrow">
		<!--
		<form action="login.jsp" method="post" name="lfrm" >
		...
		<label class="login"><%= cookies.getValue( "cid" ) %></label>
		/&nbsp;&nbsp;
		<label class="login">로그인 시간</label>
		<label class="login"><%= cookies.getValue( "cwdate" ) %></label>
